...
;(function () {
  ...
  function validSquare (square) {
    return isString(square) && square.search(/^[a-h][1-5]$/) !== -1
  }
  ...
  function validFen (fen) {
    ...
    // FEN should be 5 sections separated by slashes
  ...
  if (RUN_ASSERTS) {
    ...
    console.assert(validFen('5/5/5/5/5'))
  ...
  if (RUN_ASSERTS) {
    ...
    console.assert(objToFen({}) === '5/5/5/5/5')
  }

  function squeezeFenEmptySquares (fen) {
    return fen.replace(/11111/g, '5')
      .replace(/1111/g, '4')
      .replace(/111/g, '3')
      .replace(/11/g, '2')
  }
  ...
  function constructor (containerElOrString, config) {
    ...
    // fudge factor, and then keep reducing until we find an exact mod 5 for
    // our square size
    function calculateSquareSize () {
      ...
      while (boardWidth % 5 !== 0 && boardWidth > 0) {
    ...
    widget.resize = function () {
      ...
      // set board width
      $board.css('width', squareSize * 5 + 'px')
      ...
      if (config.sparePieces) {
        $container
          ...
          .css('paddingLeft', boardBorderSize + 'px')
      }
